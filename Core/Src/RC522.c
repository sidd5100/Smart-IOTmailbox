...
/*
 * Function Name: RC522_1_SPI_Transfer
...
/*
 * Function Name: MFRC522_1_ToCard
...
/*
 * Function Name: MFRC522_1_Request
...
/*
 * Function Name: MFRC522_1_Anticoll
...
/*
 * Function Name: MFRC522_1_SelectTag
 ...
 * Return value: the successful return MI_OK
 */
uchar MFRC522_1_Auth(uchar authMode, uchar BlockAddr, uchar *Sectorkey, uchar *serNum)
{
    uchar status;
    uint recvBits;
    uchar i;
    ...
    status = MFRC522_1_ToCard(PCD_AUTHENT, buff, 12, buff, &recvBits);

    if ((status != MI_OK) || (!(Read_1_MFRC522(Status2Reg) & 0x08)))
    {   
		status = MI_ERR;   
	}
...
/*
 * Function Name: MFRC522_1_Read
 * Description: Read block data
 * Input parameters: blockAddr - block address; recvData - read block data
 * Return value: the successful return MI_OK
 */
uchar MFRC522_1_Read(uchar blockAddr, uchar *recvData)
{
    uchar status;
    uint unLen;
    ...
    status = MFRC522_1_ToCard(PCD_TRANSCEIVE, recvData, 4, recvData, &unLen);
...
uchar MFRC522_1_Write(uchar blockAddr, uchar *writeData)
{
    ...
    status = MFRC522_1_ToCard(PCD_TRANSCEIVE, buff, 4, buff, &recvBits);
    ...
    if (status == MI_OK)
    {
        ...
        status = MFRC522_1_ToCard(PCD_TRANSCEIVE, buff, 18, buff, &recvBits);
